      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between w-full h-[70px] md:h-[80px] px-6 md:px-10 lg:px-[80px] bg-[var(--bg-dark)]">
        ...
        <a href="/" className="hidden md:block">
          <Image
            ...
            width={400}
            height={100}
            className="object-contain h-[100px] w-auto invert"
            priority
          />
        </a>
        ...
        <div className="hidden md:flex items-center gap-8 h-full">
          ...
          <button
            ...
            className="flex items-center justify-center px-8 py-3.5 rounded-[6px] bg-[var(--brand-primary)] font-display text-[15px] font-bold text-white hover:brightness-110 transition-all cursor-pointer"
          >
            Visitanos
          </button>
        ...
        <div className="flex md:hidden items-center gap-3">
          <button
            onClick={() => setMapOpen(true)}
            className="flex items-center justify-center px-6 py-3 rounded-[6px] bg-[var(--brand-primary)] font-display text-[13px] font-bold text-white cursor-pointer"
          >
            Visitanos
          </button>
